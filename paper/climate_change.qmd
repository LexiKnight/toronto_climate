...
#| message: false
#| label: table-one
#| fig-cap: "Comparison of Age Distribution Between 2018 and 2021 Surveys: This table highlights the age distribution of survey respondents in 2018 and 2021. Notable differences include a higher representation of individuals aged 18–23 in 2021 compared to 2018, while the distribution across other age groups remained relatively consistent between the two years."
...
age_summary_combined %>%
  kbl(caption = "Age Distribution Comparison for 2018 and 2021") %>%
...
# colnames(education_summary_combined) <- gsub("^X", "", colnames(education_summary_combined))
