...
## Model Takeaways
summary table age and education in predicting likelihood of taking climate actions
the accuracy of the models prediction matches the genuine data
TODO 
```{r}
#| warning: false
#| echo: false
...
TO DO: add / talk about difficulty and problems with survey data
